 ...
 */
@ApiModel(value="新增用户参数类",description="新增用户请求体")
public class UserAddIo implements Serializable {
    ...
    public UserAddIo(String userid, String username, String password, Integer type, String nickname, String picture, String email, String phone, Date createTime) {
        this.userid = userid;
