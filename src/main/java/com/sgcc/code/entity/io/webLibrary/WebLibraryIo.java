 ...
 */
@ApiModel(value="网页库默认返回参数类",description="网页库接口默认返回类")
public class WebLibraryIo implements Serializable {
	...
	public WebLibraryIo(Integer id,Integer projectId,String ispublic,String webTitle,String webDescribe,String webContent,Timestamp createTime) {
		super();
		this.id = id;
