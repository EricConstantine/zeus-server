 ...
 */
@ApiModel(value="模板查询参数类",description="查询模板请求体")
public class TemplateQueryIo implements Serializable {
	...
	public TemplateQueryIo() {
		super();
	}

	public TemplateQueryIo(String treeid,String templateName,String templateContent,String remark,Date createTime,Date updateTime) {
		super();
		this.treeid = treeid;
