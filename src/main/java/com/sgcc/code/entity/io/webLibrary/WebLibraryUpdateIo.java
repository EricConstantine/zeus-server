 ...
 */
@ApiModel(value="网页库修改参数类",description="修改网页库请求体")
public class WebLibraryUpdateIo implements Serializable {
	...
	public WebLibraryUpdateIo() {
		super();
	}

	public WebLibraryUpdateIo(Integer id,Integer projectId,String ispublic,String webTitle,String webDescribe,String webContent,Timestamp createTime) {
		super();
		this.id = id;
