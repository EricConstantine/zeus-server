 ...
 */
@ApiModel(value="脚本管理修改参数类",description="修改脚本管理请求体")
public class ShellUpdateIo implements Serializable {
	...
	public ShellUpdateIo() {
		super();
	}

    public ShellUpdateIo(Integer id, String userid, String title, String shellDescribe, String shellIp, String shellPort, String shellUsername, String shellPassword, String shellContent, Timestamp createTime) {
        this.id = id;
        this.userid = userid;
        this.title = title;
