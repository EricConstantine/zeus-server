 ...
 */
@ApiModel(value="字典修改参数类",description="修改字典请求体")
public class DictionaryUpdateIo implements Serializable {
	...
	public DictionaryUpdateIo() {
		super();
	}

    public DictionaryUpdateIo(Long id, String projectid, Integer types, String listContent, String dictionaryKey, String dictionaryValue, String dictionaryDescribe, Date createTime, Date updateTime) {
        this.id = id;
