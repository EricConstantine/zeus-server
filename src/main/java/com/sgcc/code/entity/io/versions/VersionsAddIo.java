 ...
 */
@ApiModel(value="新增版本参数类",description="新增版本请求体")
public class VersionsAddIo implements Serializable {
	...
	public VersionsAddIo() {
		super();
	}

    public VersionsAddIo(String verson, String remark, Integer uploadType, String winPath, String macPath, String currentVersion, Date createTime, Date updateTime) {
        this.verson = verson;
        this.remark = remark;
