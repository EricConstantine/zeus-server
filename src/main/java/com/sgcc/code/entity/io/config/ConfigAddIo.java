 ...
 */
@ApiModel(value="新增配置参数类",description="新增配置请求体")
public class ConfigAddIo implements Serializable {
    ...
    public ConfigAddIo(Integer projectid, String name, String configDescribe, String path, Integer dbtype, String dbhost, Integer dbport, String dbname, String dbuser, String dbpassword, String userid, Date createTime) {
