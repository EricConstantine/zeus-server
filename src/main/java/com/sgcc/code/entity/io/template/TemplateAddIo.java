 ...
 */
@ApiModel(value="新增模板参数类",description="新增模板请求体")
public class TemplateAddIo implements Serializable {
	...
	public TemplateAddIo() {
		super();
	}

	public TemplateAddIo(String treeid,String templateName,String templateContent,String remark,Date createTime,Date updateTime) {
		super();
		this.treeid = treeid;
