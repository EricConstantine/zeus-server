 ...
 */
@ApiModel(value="新增待办参数类",description="新增待办请求体")
public class TodoAddIo implements Serializable {
	...
	public TodoAddIo(String userid,String title,String content,Integer status,Date createTime) {
		super();
		this.userid = userid;
		this.title = title;
