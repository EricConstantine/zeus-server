 ...
 */
@ApiModel(value="字典查询参数类",description="查询字典请求体")
public class DictionaryQueryIo implements Serializable {
	...
	public DictionaryQueryIo() {
		super();
	}

    public DictionaryQueryIo(String projectid, Integer types, String listContent, String dictionaryKey, String dictionaryValue, String dictionaryDescribe, Date createTime, Date updateTime) {
