 ...
 */
@ApiModel(value="空间树修改参数类",description="修改空间树请求体")
public class ZonetreeUpdateIo implements Serializable {
	...
	public ZonetreeUpdateIo() {
		super();
	}

	public ZonetreeUpdateIo(Long id,Long pid,String projectid,String name,String type,String path,Date createTime,Date updateTime) {
		super();
		this.id = id;
		this.pid = pid;
